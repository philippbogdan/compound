 ...
 */
function BeforeAfterSlider({ beforeSrc, afterSrc, beforeLabel, afterLabel, beforeFallback, afterFallback, beforeIsVideo, afterIsVideo, uplift }) {
  ...
  return (
    ...
    >
      ...
      <div className="ba-slider__layer">
        {beforeSrc ? (
          beforeIsVideo ? (
            <video src={beforeSrc} autoPlay loop muted playsInline className="ba-slider__img" />
          ) : (
      ...
      <div className="ba-slider__layer ba-slider__layer--after" style={{ clipPath: `inset(0 0 0 ${pos}%)` }}>
        {afterSrc ? (
          afterIsVideo ? (
            <video src={afterSrc} autoPlay loop muted playsInline className="ba-slider__img" />
          ) : (
  ...
  return (
    ...
    >
      ...
      <div className="report__hero">
        ...
        <BeforeAfterSlider
          beforeSrc={result.video_v1_data_url || result.screenshot_v1_data_url || '/airbnb-landing.png'}
          beforeIsVideo={!!result.video_v1_data_url}
          afterSrc={result.video_v2_data_url || result.screenshot_v2_data_url || null}
          afterIsVideo={!!result.video_v2_data_url}
